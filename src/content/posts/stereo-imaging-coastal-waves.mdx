...
category: research
slug: stereo-imaging-coastal-waves
---
...
<Gallery images={[{"src": "stereo-imaging/PosterFinal1Draft.png", "caption": "Thesis Poster Draft"}]} />
<a href={siteUrl("/assets/img/stereo-imaging/PosterFinal1Draft.pdf")}> Download Poster PDF (Draft)</a>


<Gallery images={[{"src": "stereo-imaging/project1.webp", "caption": "Stereo Wave Images example"}]} />
## Project Overview
...
<Gallery images={[{"src": "stereo-imaging/IMG_4112_111032.webp", "caption": "Camera deployed near the sensor"}]} />
First, Ground control points are surveyed using RTK devices and deployed for georeferencing purposes.

<Gallery images={[{"src": "stereo-imaging/IMG_4089_111105.webp", "caption": "Ground Control Points"}]} />
After 3D reconstruction, we are able to obtain a 3D point cloud of wave fields, frame by frame. 


<Gallery images={[{"src": "stereo-imaging/project1_2.webp", "caption": "Stereo Reconstruction example"}, {"src": "stereo-imaging/IMG_4045_111132.webp", "caption": "Waves breaking at Manlipo, South Korea"}]} />
## Expected Outcomes
