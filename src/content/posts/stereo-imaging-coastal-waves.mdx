...
<Gallery
  ...
  maxPerLine={2}
  images={[
    { src: "PosterFinal1Draft.png", caption: "Thesis Poster Draft" },
    { src: "project1.webp", caption: "Stereo wave images example" },
  ]}
/>
...
Ground control points are surveyed using RTK devices and deployed for georeferencing. After 3D reconstruction, we obtain a 3D point cloud of wave fields, frame by frame.
...
<Gallery
  ...
  maxPerLine={2}
  images={[
    { src: "IMG_4112_111032.webp", caption: "Camera deployed near the sensor" },
    { src: "IMG_4089_111105.webp", caption: "Ground control points" },
    { src: "project1_2.webp", caption: "Stereo reconstruction example" },
    { src: "IMG_4045_111132.webp", caption: "Waves breaking at Manlipo, South Korea" },
  ]}
/>
