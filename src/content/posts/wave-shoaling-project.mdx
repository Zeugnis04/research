...
<a href={siteUrl("/assets/img/waveshoaling/Final.pdf")}> Read the original version (PDF)</a>
...
<Gallery images={[{"src": "waveshoaling/surfacewave.png", "caption": "Sketch of the linearized free-surface boundary conditions I re-derived before solving for pressure and velocity potentials."}]} />
...
<Gallery images={[{"src": "waveshoaling/plot12181.png", "caption": "Wave-steepness transformation computed from the conserved energy-flux relation."}]} />
...
<Gallery images={[{"src": "waveshoaling/plot12182.png", "caption": "Celerity ratio $C/C_0$ tapering with depth as predicted by the dispersion relation."}]} />
